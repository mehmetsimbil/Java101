...
public class GelismisHesapMak {
    ...
    static void mod() {
    	Scanner scan = new Scanner(System.in);
    	System.out.println("Modu alýncak sayýyý girin :");
    	int m = scan.nextInt();
    	System.out.println("Kaçlý modu alýnacak :");
    	int l = scan.nextInt();
    	System.out.println("Mod : "+m%l);
    }
    static void dikdortgen() {
    	...
    	System.out.println("Çevre hesabý için 1, Alan hesabý için 2 yi seçin.");
